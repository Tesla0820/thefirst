...
bool TutorialScene::Init()
{
  ...
  GimmickFactory::InstantiateBronzeStatue(&D3DXVECTOR3(-150.0f, 0.0f, 0.0f), &D3DXVECTOR3(0.0f, 90.0f, 0.0f), &D3DXVECTOR3(-200.0f, 0.0f, 0.0f), &D3DXVECTOR3(-100.0f, 0.0f, 0.0f), 50);
